...
public class PasswordMain extends BorderPane
{
	...
	private Label instruction4Label, instruction5Label, instruction6Label, instruction7Label;
	...
	public PasswordMain()
	{
		...
		instruction6Label = new Label("\t5.  Must contain at least one special character");
